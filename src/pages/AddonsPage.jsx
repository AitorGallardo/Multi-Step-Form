...
import { FORMS, BUTTONS_TEXT, ADDONS_OPTIONS,BILLING_PLANS } from '../constants/consts';
    ...
    >
      <section className='flex flex-col gap-4'>
        <CheckOption
          ...
          price={billingPlan === BILLING_PLANS.MONTHLY ? ONLINE.PRICE.MONTHLY : ONLINE.PRICE.YEARLY}
          time={billingPlan}
        ...
        <CheckOption
          ...
          price={billingPlan === BILLING_PLANS.MONTHLY ? STORAGE.PRICE.MONTHLY : STORAGE.PRICE.YEARLY}
          time={billingPlan}
        ...
        <CheckOption
          ...
          price={billingPlan === BILLING_PLANS.MONTHLY ? CUSTOM.PRICE.MONTHLY : CUSTOM.PRICE.YEARLY}
          time={billingPlan}
      ...
      <footer className='flex justify-between'>
        ...
        <button  className='w-fit self-end text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5'>
